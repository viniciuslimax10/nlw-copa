/*
  ...
  - You are about to drop the column `resultFirstTeamPoints` on the `Guess` table. All the data in the column will be lost.
  - You are about to drop the column `resultSecondTeamPoints` on the `Guess` table. All the data in the column will be lost.
